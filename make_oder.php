...
if (isset($_POST['make'])) {
  ...
  if (empty($_POST["order_code"]) || empty($_POST["customer_name"]) || empty($_GET['prod_price'])) {
    ...
    $postQuery = "INSERT INTO colos_orders (prod_qty, order_id, order_code, customer_id, customer_name, prod_id, prod_name, prod_price) VALUES(?,?,?,?,?,?,?,?)";
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="form-control" name="customer_name" id="custName" onChange="getCustomer(this.value)">
                      ...
                      <?php
                      //Load All Customers
                      $ret = "SELECT * FROM  colos_customers ";
                ...
                <?php
                $prod_id = $_GET['prod_id'];
                $ret = "SELECT * FROM  colos_products WHERE prod_id = '$prod_id'";
                $stmt = $mysqli->prepare($ret);
                $stmt->execute();
                $res = $stmt->get_result();
