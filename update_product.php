...
if (isset($_POST['UpdateProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price'])) {
    ...
    $postQuery = "UPDATE colos_products SET prod_code =?, prod_name =?, prod_img =?, prod_desc =?, prod_price =? WHERE prod_id = ?";
...
<body>
  ...
  <div class="main-content">
    ...
    $update = $_GET['update'];
    $ret = "SELECT * FROM  colos_products WHERE prod_id = '$update' ";
