...
if (isset($_GET['delete'])) {
  $id = $_GET['delete'];
  $adn = "DELETE FROM  colos_customers  WHERE  customer_id = ?";
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM  colos_customers  ORDER BY `colos_customers`.`created_at` DESC ";
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="customers.php?delete=<?php echo $cust->customer_id; ?>">
