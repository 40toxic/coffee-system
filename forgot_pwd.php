...
if (isset($_POST['reset_pwd'])) {
  ...
  $checkEmail = mysqli_query($mysqli, "SELECT `admin_email` FROM `colos_admin` WHERE `admin_email` = '" . $_POST['reset_email'] . "'") or exit(mysqli_error($mysqli));
  if (mysqli_num_rows($checkEmail) > 0) {
    ...
    $query = "INSERT INTO colos_pass_resets (reset_email, reset_code, reset_token, reset_status) VALUES (?,?,?,?)";
          ...
          <div class="header-body text-center mb-7">
            <div class="row justify-content-center">
              <div class="col-lg-5 col-md-6">
                <h1 class="text-white">COOL BREEZE</h1>
              </div>
            </div>
          </div>
        </div>
