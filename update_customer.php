...
if (isset($_POST['updateCustomer'])) {
  ...
  if (empty($_POST["customer_phoneno"]) || empty($_POST["customer_name"]) || empty($_POST['customer_email']) || empty($_POST['customer_password'])) {
    ...
    $postQuery = "UPDATE colos_customers SET customer_name =?, customer_phoneno =?, customer_email =?, customer_password =? WHERE  customer_id =?";
...
<body>
  ...
  <div class="main-content">
    ...
    $update = $_GET['update'];
    $ret = "SELECT * FROM  colos_customers WHERE customer_id = '$update' ";
